...
namespace zSprite
{
    public class Camera : Script
    {
        ...
        internal static void drawAll()
        {
            ...
            Root.instance.graphics.graphicsDevice.Viewport = new Viewport(Root.instance.graphics.graphicsDevice.PresentationParameters.Bounds);
            ...
            foreach (var camera in allActiveCameras)
            {
                ...
                batch.Draw(camera.target, dstr, new Rectangle(0, 0, camera._viewport.Width, camera._viewport.Height), Color.White);
            }
            //batch.DrawString(
            batch.End();
