...
namespace zSprite
{
    ...
    public struct Shape : ICollidable
    {
        ...
        public ShapeType shareType { get { return zSprite.ShapeType.Polygon; } }
        ...
        public MinimumTranslationVector intersects(ICollidable other)
        {
            ...
            else if (other.shareType == zSprite.ShapeType.Compounded)
    ...
    public struct CompoundShape : ICollidable
    {
        ...
        public ShapeType shareType { get { return zSprite.ShapeType.Compounded; } }
