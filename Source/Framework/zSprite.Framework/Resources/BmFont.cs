...
namespace zSprite.Resources
{
    public class BmFont
    {
        ...
        {
            _fontFile = fontFile;
            _material = Root.instance.resources.createMaterialFromTexture(fontTexture, fontTexture);
        ...
        internal void DrawText(int renderQueue, Vector2 pos, float scale, string text, Color color, float depth)
        {
