...
namespace zSpriteOld
{
    ...
    public struct Shape : ICollidable
    {
        ...
        public ShapeType shareType { get { return zSpriteOld.ShapeType.Polygon; } }
        ...
        public MinimumTranslationVector intersects(ICollidable other)
        {
            ...
            else if (other.shareType == zSpriteOld.ShapeType.Compounded)
    ...
    public struct CompoundShape : ICollidable
    {
        ...
        public ShapeType shareType { get { return zSpriteOld.ShapeType.Compounded; } }
